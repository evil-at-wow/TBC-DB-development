...
DELETE FROM `creature_movement_template` WHERE entry IN (SELECT id FROM `creature` WHERE map = 429);
...
(@NEW_GUID_START+0, 11454, 429, 1, 0, 0, 55.3767, -713.761, -25.0775, 3.61283, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Betrayer
(@NEW_GUID_START+1, 11451, 429, 1, 0, 0, 55.9418, -720.741, -25.0775, 6.24828, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Satyr
(@NEW_GUID_START+2, 11451, 429, 1, 0, 0, 56.7221, -706.941, -25.0775, 4.5204, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Satyr
-- Betrayer/Satyr/Satyr Group 2, down at the ramp
(@NEW_GUID_START+3, 11454, 429, 1, 0, 0, 22.7961, -680.046, -25.0783, 3.89208, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Betrayer
(@NEW_GUID_START+4, 11451, 429, 1, 0, 0, 24.2224, -674.951, -25.1616, 4.14954, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Satyr
(@NEW_GUID_START+5, 11451, 429, 1, 0, 0, 15.5073, -680.307, -25.0783, 5.81195, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Satyr
-- Betrayer/Satyr/Satyr Group 3, near the hallway leading to the room with Lethtendris
(@NEW_GUID_START+6, 11454, 429, 1, 0, 0, 59.6724, -603.951, -25.1302, 5.07981, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Betrayer
(@NEW_GUID_START+7, 11451, 429, 1, 0, 0, 55.0125, -602.04, -25.0646, 3.37677, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Satyr
(@NEW_GUID_START+8, 11451, 429, 1, 0, 0, 65.0294, -608.021, -25.0719, 6.16101, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Satyr
-- Moving between Betrayer/Satyr/Satyr Group 1 and Betrayer/Satyr/Satyr Group 2
(@NEW_GUID_START+9, 11455, 429, 1, 0, 0, 51.3525, -721.915, -25.1438, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Wildspawn Felsworn
...
(@NEW_GUID_START+10, 13196, 429, 1, 0, 0, 51.1273, -748.835, -25.1003, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Phase Lasher
(@NEW_GUID_START+11, 13197, 429, 1, 0, 0, 51.1273, -748.835, -25.1003, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Fel Lash
(@NEW_GUID_START+12, 13196, 429, 1, 0, 0, 51.1414, -755.75, -25.0891, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Phase Lasher
(@NEW_GUID_START+13, 13197, 429, 1, 0, 0, 51.1414, -755.75, -25.0891, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Fel Lash
-- Near the hallway leading to the room with Lethtendris.
(@NEW_GUID_START+14, 13196, 429, 1, 0, 0, 61.9258, -648.15, -25.1335, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Phase Lasher
(@NEW_GUID_START+15, 13197, 429, 1, 0, 0, 61.9258, -648.15, -25.1335, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Fel Lash
(@NEW_GUID_START+16, 13196, 429, 1, 0, 0, 64.6844, -620.783, -25.1592, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Phase Lasher
(@NEW_GUID_START+17, 13197, 429, 1, 0, 0, 64.6844, -620.783, -25.1592, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Fel Lash

-- Near the ramp
(@NEW_GUID_START+18, 11456, 429, 1, 0, 0, 12.2163, -707.55, -25.0783, 1.93732, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Shadowstalker
(@NEW_GUID_START+19, 11456, 429, 1, 0, 0, 64.4071, -678.472, -25.0772, 4.13643, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Shadowstalker
-- Near the hallway to the room with Lethtendris
(@NEW_GUID_START+20, 11456, 429, 1, 0, 0, 30.1011, -618.51, -25.0722, 2.37365, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1); -- Wildspawn Shadowstalker
...
INSERT INTO `creature` (guid, id, map, spawnMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
(@NEW_GUID_START+21, 11456, 429, 1, 0, 0, 111.56, -367.658, -4.10329, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2); -- Wildspawn Shadowstalker
...
(@NEW_GUID_START+22, 11454, 429, 1, 0, 0, 57.5876, -400.81, -4.13621, 2.07694, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Betrayer
(@NEW_GUID_START+23, 11451, 429, 1, 0, 0, 52.2995, -397.91, -4.13716, 0.523599, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Satyr
(@NEW_GUID_START+24, 11451, 429, 1, 0, 0, 61.941, -399.15, -4.13689, 2.51327, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Satyr
-- Betrayer/Satyr/Satyr Group 5, west side, middle
(@NEW_GUID_START+25, 11454, 429, 1, 0, 0, -21.4801, -401.265, -4.13795, 1.27409, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Betrayer
(@NEW_GUID_START+26, 11451, 429, 1, 0, 0, -27.4422, -398.865, -4.22046, 4.90128, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Satyr
(@NEW_GUID_START+27, 11451, 429, 1, 0, 0, -14.4985, -399.14, -4.13787, 2.23402, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Satyr
-- Betrayer/Satyr/Satyr Group 6, west side, south
(@NEW_GUID_START+28, 11454, 429, 1, 0, 0, -80.4437, -401.602, -4.13549, 1.8326, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Betrayer
(@NEW_GUID_START+29, 11451, 429, 1, 0, 0, -75.5403, -395.85, -4.13737, 2.54818, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Satyr
(@NEW_GUID_START+30, 11451, 429, 1, 0, 0, -86.6004, -400.982, -4.21903, 1.08976, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Satyr
-- Betrayer/Satyr/Satyr Group 7, east side, middle
(@NEW_GUID_START+31, 11454, 429, 1, 0, 0, -17.7285, -459.476, -4.14758, 4.55531, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Betrayer
(@NEW_GUID_START+32, 11451, 429, 1, 0, 0, -12.4978, -462.705, -4.15329, 3.61283, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Satyr
(@NEW_GUID_START+33, 11451, 429, 1, 0, 0, -25.777, -462.07, -4.14609, 5.79449, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Satyr
-- East side, north
(@NEW_GUID_START+34, 11455, 429, 1, 0, 0, 53.2125, -458.915, -4.13168, 6.26573 , @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Felsworn
-- Walking around the north pillar
(@NEW_GUID_START+35, 11455, 429, 1, 0, 0, 2.77891, -426.083, -4.22211, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Wildspawn Felsworn
-- Walking around the south pillar
(@NEW_GUID_START+36, 11455, 429, 1, 0, 0, -66.3458, -425.147, -4.22617, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Wildspawn Felsworn
-- Moving between Betrayer/Satyr/Satyr Group 4 and Betrayer/Satyr/Satyr Group 5
(@NEW_GUID_START+37, 11455, 429, 1, 0, 0, 53.4373, -402.78, -4.21671, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Wildspawn Felsworn
-- Moving between Betrayer/Satyr/Satyr Group 6 and Betrayer/Satyr/Satyr Group 7
(@NEW_GUID_START+38, 11455, 429, 1, 0, 0, -23.1693, -457.025, -4.22551, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Wildspawn Felsworn

-- There are four spawn points in the room that can be either a Fel Lash or a Phase Lasher, at random.
-- We'll spawn both at each point and put them in a pool so one is selected at random (see below).
-- East side, north
(@NEW_GUID_START+39, 13196, 429, 1, 0, 0, 21.0046, -457.192, -4.1597, 0.715585, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Phase Lasher
(@NEW_GUID_START+40, 13197, 429, 1, 0, 0, 21.0046, -457.192, -4.1597, 0.715585, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Fel Lash
-- West side, north
(@NEW_GUID_START+41, 13196, 429, 1, 0, 0, 15.1764, -402.726, -4.138, 4.92183, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Phase Lasher
(@NEW_GUID_START+42, 13197, 429, 1, 0, 0, 15.1764, -402.726, -4.138, 4.92183, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Fel Lash
-- West side, middle
(@NEW_GUID_START+43, 13196, 429, 1, 0, 0, -48.4529, -401.622, -4.13796, 5.13127, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Phase Lasher
(@NEW_GUID_START+44, 13197, 429, 1, 0, 0, -48.4529, -401.622, -4.13796, 5.13127, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Fel Lash
-- West side, south
(@NEW_GUID_START+45, 13196, 429, 1, 0, 0, -104.776, -405.624, -4.13418, 5.55015, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Phase Lasher
(@NEW_GUID_START+46, 13197, 429, 1, 0, 0, -104.776, -405.624, -4.13418, 5.55015, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Fel Lash

(@NEW_GUID_START+47, 14327, 429, 1, 0, 0, -5.45062, -441.126, 16.4179, 0.531164, @BOSS_RESPAWN_TIME, 0, 0, 17816, 8964, 0, 2), -- Lethtendris
(@NEW_GUID_START+48, 14349, 429, 1, 0, 0, -6.91042, -440.736, 16.4178, 6.0218, @BOSS_RESPAWN_TIME, 0, 0, 6477, 6489, 0, 0); -- Pimgib
...
(@NEW_GUID_START+49, 13196, 429, 1, 0, 0, -25.8675, -208.432, -3.97046, 0.820305, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Phase Lasher (removed in 4.0.3a)
(@NEW_GUID_START+50, 13196, 429, 1, 0, 0, -85.9347, -208.182, -3.96894, 0.541052, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Phase Lasher
(@NEW_GUID_START+51, 13196, 429, 1, 0, 0, -166.726, -271.487, -4.06308, 5.68977, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Phase Lasher (removed in 4.0.3a)
(@NEW_GUID_START+52, 13196, 429, 1, 0, 0, -146.427, -366.639, -4.06831, 1.90241, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Phase Lasher
(@NEW_GUID_START+53, 13196, 429, 1, 0, 0, -51.43, -358.119, -4.05449, 2.16421, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Phase Lasher (removed in 4.0.3a)
(@NEW_GUID_START+54, 13196, 429, 1, 0, 0, 70.9002, -357.223, -4.04807, 0.977384, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Phase Lasher
-- Warpwood Crusher spawns counterclockwise, starting near the dungeon entrance.
(@NEW_GUID_START+55, 13021, 429, 1, 0, 0, -16.8805, -177.09, -2.63107, 4.81711, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Crusher
(@NEW_GUID_START+56, 13021, 429, 1, 0, 0, -87.1855, -173.293, -2.63107, 4.86947, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Crusher (removed in 4.0.3a)
(@NEW_GUID_START+57, 13021, 429, 1, 0, 0, -135.92,  -278.62, -3.97313, 3.47321, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Crusher
(@NEW_GUID_START+58, 13021, 429, 1, 0, 0, -110.687, -357.62, -4.05201, 1.65806, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Crusher (removed in 4.0.3a)
(@NEW_GUID_START+59, 13021, 429, 1, 0, 0, -20.0212, -366.39, -4.04007, 1.81514, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Crusher
(@NEW_GUID_START+60, 13021, 429, 1, 0, 0, 131.583, -352.838, -4.06887,  3.36849, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Crusher (removed in 4.0.3a)
(@NEW_GUID_START+61, 13021, 429, 1, 0, 0, 134.906, -288.916, -4.06306, 3.54302, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Crusher
-- Group south/west
(@NEW_GUID_START+62, 13022, 429, 1, 0, 0, -148.843, -200.749, -4.21083, 4.27233, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+63, 13022, 429, 1, 0, 0, -149.702, -197.893, -4.21031, 5.77921, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+64, 13022, 429, 1, 0, 0, -156.945, -201.478, -4.06936, 5.21853, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+65, 13022, 429, 1, 0, 0, -152.666, -202.802, -4.06916, 3.33358, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+66, 13022, 429, 1, 0, 0, -157.879, -198.865, -4.18982, 0.402479, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+67, 13022, 429, 1, 0, 0, -154.058, -198.694, -4.19924, 2.28912, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+68, 13022, 429, 1, 0, 0, -154.099, -195.957, -4.20064, 4.23252, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
-- Group south/east (removed in 4.0.3a)
(@NEW_GUID_START+69, 13022, 429, 1, 0, 0, -147.416, -325.322, -4.14834, 1.5089, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+70, 13022, 429, 1, 0, 0, -143.089, -330.215, -4.02938, 0.959931, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+71, 13022, 429, 1, 0, 0, -140.131, -325.933, -4.09224, 5.21016, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START
 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Treant
-- Tangler/Treant/Treant Group 2, south west (removed in 4.0.3a)
(@NEW_GUID_START+107, 11464, 429, 1, 0, 0, -115.532, -200.983, -4.09197, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Tangler
(@NEW_GUID_START+108, 11462, 429, 1, 0, 0, -115.532, -200.983, -4.09197, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Treant
(@NEW_GUID_START+109, 11462, 429, 1, 0, 0, -115.532, -200.983, -4.09197, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Treant
-- Tangler/Treant/Treant Group 3, south
(@NEW_GUID_START+110, 11464, 429, 1, 0, 0, -159.065, -285.835, -4.17517, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Tangler
(@NEW_GUID_START+111, 11462, 429, 1, 0, 0, -159.065, -285.835, -4.17517, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Treant
(@NEW_GUID_START+112, 11462, 429, 1, 0, 0, -159.065, -285.835, -4.17517, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Treant
-- Tangler/Treant/Treant Group 4, south east
(@NEW_GUID_START+113, 11464, 429, 1, 0, 0, -34.0211, -368.15, -4.10071, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Tangler
(@NEW_GUID_START+114, 11462, 429, 1, 0, 0, -34.0211, -368.15, -4.10071, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Treant
(@NEW_GUID_START+115, 11462, 429, 1, 0, 0, -34.0211, -368.15, -4.10071, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Treant
-- Tangler/Treant/Treant Group 5, east (removed in 4.0.3a)
(@NEW_GUID_START+116, 11464, 429, 1, 0, 0, -96.5183, -347.559, -4.04812, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Tangler
(@NEW_GUID_START+117, 11462, 429, 1, 0, 0, -96.5183, -347.559, -4.04812, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Treant
(@NEW_GUID_START+118, 11462, 429, 1, 0, 0, -96.5183, -347.559, -4.04812, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Treant
-- Tangler/Treant/Treant Group 6, north east
(@NEW_GUID_START+119, 11464, 429, 1, 0, 0, 71.9864, -345.765, -4.03809, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Tangler
(@NEW_GUID_START+120, 11462, 429, 1, 0, 0, 71.9864, -345.765, -4.03809, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Treant
(@NEW_GUID_START+121, 11462, 429, 1, 0, 0, 71.9864, -345.765, -4.03809, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Treant
...
(@NEW_GUID_START+122, 11464, 429, 1, 0, 0, 102.259, -189.041, -4.14403, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Tangler
(@NEW_GUID_START+123, 11462, 429, 1, 0, 0, 102.259, -189.041, -4.14403, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Treant
(@NEW_GUID_START+124, 11464, 429, 1, 0, 0, 136.63, -297.89, -4.14037, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Tangler (reused path!)
(@NEW_GUID_START+125, 11462, 429, 1, 0, 0, 136.63, -297.89, -4.14037, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Treant (reused path!)

(@NEW_GUID_START+126, 14354, 429, 1, 0, 0, 86.1935, -197.888, -4.05657, 1.76278, @BOSS_RESPAWN_TIME, 0, 0, 0, 0, 0, 2); -- Pusillin
...
(@NEW_GUID_START+127, 13197, 429, 1, 0, 0, -35.181, -458.88, -58.5327, 2.26893, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Fel Lash
-- North/East
(@NEW_GUID_START+128, 13197, 429, 1, 0, 0, 47.3864, -447.764, -58.5225, 3.75246, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Fel Lash
-- North/West
(@NEW_GUID_START+129, 13197, 429, 1, 0, 0, 55.5946, -405.276, -58.5211, 3.9968, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Fel Lash
-- Group south/east
(@NEW_GUID_START+130, 11453, 429, 1, 0, 0, -93.0634, -461.176, -58.6221, 5.70493, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Trickster
(@NEW_GUID_START+131, 11452, 429, 1, 0, 0, -94.5833, -466.205, -58.6246, 2.23612, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Rogue
(@NEW_GUID_START+132, 11452, 429, 1, 0, 0, -84.7378, -460.673, -58.5294, 2.68781, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Rogue
-- Group south/east
(@NEW_GUID_START+133, 11457, 429, 1, 0, 0, -69.0547, -442.536, -58.6142, 1.13804, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Hellcaller
(@NEW_GUID_START+134, 13276, 429, 1, 0, 0, -70.9053, -439.957, -58.6127, 0.913746, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+135, 13276, 429, 1, 0, 0, -64.4045, -442.443, -58.6145, 1.04908, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+136, 13276, 429, 1, 0, 0, -72.5177, -436.876, -58.611, 4.10582, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+137, 13276, 429, 1, 0, 0, -61.434, -444.802, -58.5307, 6.16101, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+138, 13276, 429, 1, 0, 0, -71.6369, -440.319, -58.6128, 0.256474, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
-- Group east
(@NEW_GUID_START+139, 11457, 429, 1, 0, 0, -6.88377, -459.375, -58.5461, 0.872665, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Hellcaller
(@NEW_GUID_START+140, 13276, 429, 1, 0, 0, -3.22096, -460.538, -58.549, 1.3439, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+141, 13276, 429, 1, 0, 0, -14.1565, -460.888, -58.6237, 4.10695, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+142, 13276, 429, 1, 0, 0, -6.83229, -455.483, -58.5433, 0.366519, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+143, 13276, 429, 1, 0, 0, -3.05802, -456.817, -58.5464, 0.366519, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+144, 13276, 429, 1, 0, 0, -10.9179, -456.242, -58.6249, 0.31074, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
-- Group north
(@NEW_GUID_START+145, 11453, 429, 1, 0, 0, 74.8293, -435.001, -58.5152, 1.06465, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Trickster
(@NEW_GUID_START+146, 11453, 429, 1, 0, 0, 68.7285, -422.43, -58.6015, 5.77543, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Trickster
(@NEW_GUID_START+147, 11452, 429, 1, 0, 0, 70.4284, -429.825, -58.6012, 0.320256, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Rogue
(@NEW_GUID_START+148, 11452, 429, 1, 0, 0, 74.9546, -417.913, -58.5995, 0.030332, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Rogue
-- Group north/west
(@NEW_GUID_START+149, 11457, 429, 1, 0, 0, 37.3552, -392.268, -58.5272, 2.37365, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Hellcaller
(@NEW_GUID_START+150, 13276, 429, 1, 0, 0, 32.1917, -393.651, -58.6118, 0.535442, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+151, 13276, 429, 1, 0, 0, 42.2916, -388.172, -58.5281, 5.48033, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+152, 13276, 429, 1, 0, 0, 40.4389, -397.353, -58.5258, 1.71042, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+153, 13276, 429, 1, 0, 0, 34.4894, -396.159, -58.5277, 1.20428, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+154, 13276, 429, 1, 0, 0, 43.4029, -392.169, -58.5266, 4.11898, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
-- Group west (removed in 4.0.3a)
(@NEW_GUID_START+155, 11453, 429, 1, 0, 0, -23.6704, -398.692, -58.6164, 0.80207, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Trickster
(@NEW_GUID_START+156, 11453, 429, 1, 0, 0, -10.3481, -393.132, -58.5304, 1.90241, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Trickster
(@NEW_GUID_START+157, 11452, 429, 1, 0, 0, -16.0019, -395.454, -58.5304, 4.55531, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Rogue
(@NEW_GUID_START+158, 11452, 429, 1, 0, 0, -28.3503, -391.94, -58.618, 2.83299, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Rogue
-- Group south/west
(@NEW_GUID_START+159, 11453, 429, 1, 0, 0, -90.2836, -391.934, -58.4822, 3.01942, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Trickster
(@NEW_GUID_START+160, 11453, 429, 1, 0, 0, -79.7413, -389.324, -58.5109, 1.25664, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Trickster
(@NEW_GUID_START+161, 11452, 429, 1, 0, 0, -84.0613, -392.13, -58.4799, 0.959931, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Rogue
(@NEW_GUID_START+162, 11452, 429, 1, 0, 0, -96.6476, -388.518, -58.52, 4.5204, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Rogue
-- Spawn three Small Frogs in Hydrospawn's pool
(@NEW_GUID_START+163, 13321, 429, 1, 0, 0, 1.08285, -427.635, -58.2154, 0.942478, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Small Frog
(@NEW_GUID_START+164, 13321, 429, 1, 0, 0, -21.3831, -431.467, -58.527, 3.7001, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Small Frog
(@NEW_GUID_START+165, 13321, 429, 1, 0, 0, -21.032, -425.93, -58.1864, 1.81514, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Small Frog

(@NEW_GUID_START+166, 13280, 429, 1, 0, 0, 4.57887, -438.407, -59.954, 0, @BOSS_RESPAWN_TIME, 0, 0, 22270, 6723, 0, 2), -- Hydrospawn

-- Wildspawn Shadowstalker patrolling between the room with Hydrospawn (south east) and the room with Lethtendris
(@NEW_GUID_START+167, 11456, 429, 1, 0, 0, -148.751, -487.5, -36.871, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Wildspawn Shadowstalker
-- Wildspawn Shadowstalker patrolling between the room with Hydrospawn (north east) and the room with Zevrim Thornhoof
(@NEW_GUID_START+168, 11456, 429, 1, 0, 0, 46.9284, -465.54, -58.631, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Wildspawn Shadowstalker
-- Wildspawn Shadowstalker patrolling between the room with Hydrospawn (south west) and The Conservatory
(@NEW_GUID_START+169, 11456, 429, 1, 0, 0, -57.0053, -401.183, -58.5854, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Wildspawn Shadowstalker
-- Wildspawn Shadowstalker, west side
(@NEW_GUID_START+170, 11456, 429, 1, 0, 0, 4.50979, -386.047, -58.5316, 1.16937, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1); -- Wildspawn Shadowstalker
...
INSERT INTO `creature` (guid, id, map, spawnMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
(@NEW_GUID_START+171, 11457, 429, 1, 0, 0, 4.60055, -437.18, -37.8782, 4.27606, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Hellcaller
(@NEW_GUID_START+172, 13276, 429, 1, 0, 0, 7.56612, -440.69, -37.8779, 3.89208, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+173, 13276, 429, 1, 0, 0, 1.65759, -434.832, -37.9608, 0.775787, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+174, 13276, 429, 1, 0, 0, 1.53725, -438.741, -37.9606, 1.07755, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+175, 13276, 429, 1, 0, 0, 7.73413, -443.673, -37.8776, 3.12414, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+176, 13276, 429, 1, 0, 0, -1.03906, -435.259, -37.9609, 5.92277, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Wildspawn Imp
(@NEW_GUID_START+177, 11490, 429, 1, 0, 0, -34.983, -448, -37.8785, 0.191986, @BOSS_RESPAWN_TIME, 0, 0, 22272, 0, 0, 0); -- Zevrim Thornhoof
...
-- North west corner
(@NEW_GUID_START+178, 13022, 429, 1, 0, 0, 122.508, -193.592, -55.2534, 3.11933, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+179, 13022, 429, 1, 0, 0, 118.955, -189.796, -54.6273, 3.18426, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+180, 13022, 429, 1, 0, 0, 115.228, -192.819, -55.0426, 2.91091, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+181, 13022, 429, 1, 0, 0, 115.228, -195.967, -55.6115, 3.54147, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+182, 13022, 429, 1, 0, 0, 118.605, -198.995, -55.8831, 4.91481, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+183, 13022, 429, 1, 0, 0, 126.482, -204.473, -56.2875, 4.26236, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+184, 13022, 429, 1, 0, 0, 110.761, -197.604, -55.6668, 4.2586, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+185, 13022, 429, 1, 0, 0, 109.855, -191.323, -54.5, 5.53269, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+186, 13022, 429, 1, 0, 0, 106.918, -189.179, -54.0493, 1.81514, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+187, 13022, 429, 1, 0, 0, 103.901, -194.5, -54.9578, 4.32842, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
-
@TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Death Lash
(@NEW_GUID_START+260, 13285, 429, 1, 0, 0, -38.4972, -194.397, -55.7837, 5.37561, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Death Lash
(@NEW_GUID_START+261, 13285, 429, 1, 0, 0, -114.832, -195.776, -52.6459, 0.331613, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Death Lash
-- East wall, north to south
(@NEW_GUID_START+262, 13285, 429, 1, 0, 0, 115.866, -356.124, -54.999, 4.36332, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Death Lash
(@NEW_GUID_START+263, 13285, 429, 1, 0, 0, 80.1832, -334.151, -53.8089, 2.1293, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Death Lash
(@NEW_GUID_START+264, 13285, 429, 1, 0, 0, 40.6147, -361.182, -54.0435, 1.58825, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Death Lash
(@NEW_GUID_START+265, 13285, 429, 1, 0, 0, -129.867, -334.241, -56.7992, 5.16617, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Death Lash
-- Center, north to south
(@NEW_GUID_START+266, 13285, 429, 1, 0, 0, 14.3321, -261.833, -52.0997, 4.43314, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Death Lash
(@NEW_GUID_START+267, 13285, 429, 1, 0, 0, -99.1422, -249.61, -56.6773, 5.14872, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Death Lash
(@NEW_GUID_START+268, 13285, 429, 1, 0, 0, -129.888, -246.628, -54.0495, 5.41052, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Death Lash

-- Stomper/Guardian/Guardian Group 1
(@NEW_GUID_START+269, 11465, 429, 1, 0, 0, -64.3225, -359.79, -55.9148, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Stomper
(@NEW_GUID_START+270, 11461, 429, 1, 0, 0, -64.3225, -359.79, -55.9148, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Guardian
(@NEW_GUID_START+271, 11461, 429, 1, 0, 0, -64.3225, -359.79, -55.9148, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Guardian
-- Stomper/Guardian/Guardian Group 2
(@NEW_GUID_START+272, 11465, 429, 1, 0, 0, -30.6938, -300.574, -54.0977, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Stomper
(@NEW_GUID_START+273, 11461, 429, 1, 0, 0, -30.6938, -300.574, -54.0977, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Guardian
(@NEW_GUID_START+274, 11461, 429, 1, 0, 0, -30.6938, -300.574, -54.0977, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Guardian
-- Stomper/Guardian/Guardian Group 3
(@NEW_GUID_START+275, 11465, 429, 1, 0, 0, -17.7006, -293.797, -54.1351, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Stomper
(@NEW_GUID_START+276, 11461, 429, 1, 0, 0, -17.7006, -293.797, -54.1351, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Guardian
(@NEW_GUID_START+277, 11461, 429, 1, 0, 0, -17.7006, -293.797, -54.1351, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Guardian
-- Stomper/Guardian/Guardian Group 4
(@NEW_GUID_START+278, 11465, 429, 1, 0, 0, 81.8962, -283.248, -55.1609, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Stomper
(@NEW_GUID_START+279, 11461, 429, 1, 0, 0, 81.8962, -283.248, -55.1609, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Guardian
(@NEW_GUID_START+280, 11461, 429, 1, 0, 0, 81.8962, -283.248, -55.1609, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Guardian
-- Stomper/Guardian/Guardian Group 5
(@NEW_GUID_START+281, 11465, 429, 1, 0, 0, 38.298, -314.189, -52.4531, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Stomper
(@NEW_GUID_START+282, 11461, 429, 1, 0, 0, 38.298, -314.189, -52.4531, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Guardian
(@NEW_GUID_START+283, 11461, 429, 1, 0, 0, 38.298, -314.189, -52.4531, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Guardian

(@NEW_GUID_START+284, 11491, 429, 1, 0, 0, -72.1719, -283.252, -57.7497, 4.08407, @BOSS_RESPAWN_TIME, 0, 0, 0, 0, 0, 0); -- Old Ironbark
...
(@NEW_GUID_START+285, 13021, 429, 1, 0, 0, 330.651, -375.383, -71.0516, 3.9968, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Crusher
-- Left side, a bit down (removed in 4.0.3a)
(@NEW_GUID_START+286, 13021, 429, 1, 0, 0, 360.391, -436.849, -87.297, 3.31613, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Crusher
-- Left side, almost down (removed in 4.0.3a)
(@NEW_GUID_START+287, 13021, 429, 1, 0, 0, 360.356, -490.424, -101.987, 3.15905, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Crusher
-- Right side, near the entrance of the room (still exists, but at a slightly different position)
(@NEW_GUID_START+288, 13021, 429, 1, 0, 0, 216.978, -356.29, -67.4426, 5.11381, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Crusher
-- Right side, almost down
(@NEW_GUID_START+289, 13021, 429, 1, 0, 0, 187.1, -543.165, -111.892, 0.680678, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0), -- Warpwood Crusher
-- Patrolling along the outside.
(@NEW_GUID_START+290, 13021, 429, 1, 0, 0, 197.831, -483.199, -100.907, 0, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 2), -- Warpwood Crusher
...
(@NEW_GUID_START+291, 13285, 429, 1, 0, 0, 290.355, -470.042, -119.878, 3.31613, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Death Lash
(@NEW_GUID_START+292, 13197, 429, 1, 0, 0, 290.355, -470.042, -119.878, 3.31613, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Fel Lash
(@NEW_GUID_START+293, 13022, 429, 1, 0, 0, 292.697, -476.578, -119.036, 5.58505, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+294, 13022, 429, 1, 0, 0, 287.544, -479.895, -119.036, 5.74213, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+295, 13022, 429, 1, 0, 0, 299.18, -474.913, -119.036, 2.80998, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+296, 13022, 429, 1, 0, 0, 292.824, -482.119, -119.036, 3.89208, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher

-- Death Lash/Fel Lash + 2x-4x Whip Lasher Group 2
(@NEW_GUID_START+297, 13285, 429, 1, 0, 0, 285.642, -501.949, -119.036, 2.14675, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Death Lash
(@NEW_GUID_START+298, 13197, 429, 1, 0, 0, 285.642, -501.949, -119.036, 2.14675, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Fel Lash
(@NEW_GUID_START+299, 13022, 429, 1, 0, 0, 281.187, -499.258, -119.036, 0, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+300, 13022, 429, 1, 0, 0, 289.159, -504.723, -119.036, 0, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+301, 13022, 429, 1, 0, 0, 282.743, -504.313, -119.036, 0, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+302, 13022, 429, 1, 0, 0, 288.645, -499.382, -119.036, 0, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher

-- Death Lash/Fel Lash + 2x-4x Whip Lasher Group 3
(@NEW_GUID_START+303, 13285, 429, 1, 0, 0, 246.913, -485.775, -119.036, 0, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Death Lash
(@NEW_GUID_START+304, 13197, 429, 1, 0, 0, 246.913, -485.775, -119.036, 0, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Fel Lash
(@NEW_GUID_START+305, 13022, 429, 1, 0, 0, 245.336, -492.562, -119.036, 0, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+306, 13022, 429, 1, 0, 0, 243.656, -487.932, -119.036, 5.20108, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+307, 13022, 429, 1, 0, 0, 239.995, -491.467, -119.036, 0, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher
(@NEW_GUID_START+308, 13022, 429, 1, 0, 0, 241.339, -484.667, -119.036, 0, @TRASH_RESPAWN_TIME, 2, 0, 0, 0, 0, 1), -- Whip Lasher

(@NEW_GUID_START+309, 11492, 429, 1, 0, 0, 274.844, -427.251, -119.962, 0.970313, @BOSS_RESPAWN_TIME, 5, 0, 0, 0, 0, 2), -- Alzzin the Wildshaper
(@NEW_GUID_START+310, 16045, 429, 1, 0, 0, 262.09, -445.745, -119.878, 4.32842, @TRASH_RESPAWN_TIME, 0, 0, 0, 0, 0, 0); -- Isalien Trigger
...
UPDATE `creature` SET curhealth = (SELECT minhealth FROM `creature_template` WHERE entry = id) WHERE map = 429 AND curhealth = 0;
UPDATE `creature` SET curmana = (SELECT minmana FROM `creature_template` WHERE entry = id) WHERE map = 429 AND curmana = 0;
...
UPDATE `conditions` SET value1 = 1 WHERE condition_entry = 462;
UPDATE `conditions` SET value1 = 9 WHERE condition_entry = 471;
UPDATE `conditions` SET value1 = 19 WHERE condition_entry = 463;
UPDATE `conditions` SET value1 = 32 WHERE condition_entry = 472;
UPDATE `conditions` SET value1 = 38 WHERE condition_entry = 473;
